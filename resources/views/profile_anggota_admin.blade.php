...
<body class="landing-page">@include('sidebar_admin')
    <div class="main-content" id="profilePage">
        <form id="profileUpdateForm" action="{{ route('admin.anggota.update', ['token' => $token, 'anggota' => $anggota->id]) }}" method="POST">
            @csrf
            ...
            <div class="card" id="profile-card">
                <div class="card-header">
                    ...
                    {{-- Tombol kembali mengarah ke halaman daftar anggota --}}
                    ...
                    <div class="btn">
                        ...
                        <div class="menu-price">
                            ...
                            <select name="status" class="edit-mode">
                                <option value="aktif" {{ $anggota->status == 'aktif' ? 'selected' : '' }}>Active</option>
                                <option value="nonaktif" {{ $anggota->status == 'nonaktif' ? 'selected' : '' }}>Non-Active</option>
                                <option value="demo" {{ $anggota->status == 'demo' ? 'selected' : '' }}>Demo</option>
                            </select>
                        </div>
                    </div>
                    <div class="btn">
                        ...
                        <div class="menu-price">
                            ...
                            <select name="role" class="edit-mode">
                                <option value="standard" {{ $anggota->role == 'standard' ? 'selected' : '' }}>Standard</option>
                                <option value="pro" {{ $anggota->role == 'pro' ? 'selected' : '' }}>Pro</option>
                ...
                <div class="menu-grid">
                    ...
                    <div class="btn">
                        ...
                        <div class="menu-price">
                            ...
                            <input type="password" name="password" placeholder="Isi password baru (opsional)" class="edit-mode">
                        </div>
                    </div>
    ...
    <div id="saveConfirmModal" class="modal-overlay" style="display: none;">
        <div class="modal-content">
            ...
            <div class="modal-actions">
                ...
                <button id="confirmSaveBtn" class="btn-primary">Ya, Simpan</button>
            </div>
        </div>
    </div>
